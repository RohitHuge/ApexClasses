        ...
        <div className="relative flex h-auto w-full flex-col overflow-x-hidden">
          ...
          <section className="relative py-20 px-6 md:px-20">
            <div className="max-w-7xl mx-auto">
              <div className="relative rounded-3xl overflow-hidden bg-navy min-h-[500px] flex items-center shadow-2xl">
                ...
                <div className="relative z-10 p-8 md:p-16 max-w-2xl">
                  <span className="inline-block px-4 py-1.5 rounded-full bg-primary/20 text-primary font-bold text-xs uppercase tracking-widest mb-6 border border-primary/30">Expert Guidance</span>
                  <h1 className="text-white text-4xl md:text-6xl font-black leading-tight mb-6">
                    Why You Need Expert <span className="text-primary">Counselling?</span>
                  </h1>
                  ...
                  <button className="flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-xl shadow-primary/30">
              ...
              <div className="w-full md:w-1/2">
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-8 rounded-2xl border border-slate-100 shadow-sm">
                    <h2 className="text-3xl font-bold text-navy mb-6">The Complexity of Choice</h2>
                    <p className="text-slate-600 text-lg leading-relaxed mb-6">
                      The admission form allows up to <span className="font-bold text-primary">300+ preference selections</span>. Without proper planning, one wrong move in your priority list can cost you an entire academic year or a seat in a top-tier college.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-slate-50 rounded-xl">
                        <div className="text-primary font-black text-2xl mb-1">300+</div>
                        <div className="text-xs font-semibold uppercase text-slate-500">Form Selections</div>
                      </div>
                      <div className="p-4 bg-slate-50 rounded-xl">
                        <div className="text-primary font-black text-2xl mb-1">Top 1%</div>
          ...
          <section className="py-20 px-6 md:px-20">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-black text-navy mb-4">Why a Paid Counsellor Matters?</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all">
                  ...
                  <h3 className="text-xl font-bold text-navy mb-4">5-Year Cutoff Trends</h3>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all">
                  ...
                  <h3 className="text-xl font-bold text-navy mb-4">68 Colleges in Pune</h3>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all">
                  ...
                  <h3 className="text-xl font-bold text-navy mb-4">Zero Error Process</h3>
          ...
          <section className="py-12 px-6 md:px-20">
            <div className="max-w-7xl mx-auto">
              <div className="bg-gradient-to-r from-primary to-orange-600 rounded-3xl p-8 md:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 min-w-[280px] shadow-lg">
                  <div className="text-center">
                    ...
                    <button className="w-full py-3 bg-white text-primary font-bold rounded-xl hover:bg-slate-50 transition-colors shadow-md">Check Eligibility</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 px-6 md:px-20 bg-slate-50">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                <div>
                  <h2 className="text-3xl font-black text-navy mb-2">Massive Choice Landscape</h2>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <div key={item.name} className="bg-white p-6 rounded-2xl border-b-4 border-primary shadow-sm hover:shadow-md transition-shadow">
                    <h4 className="text-navy font-bold text-lg mb-4">{item.name}</h4>
                    <div className="flex items-baseline gap-2">
                      <span className="text-4xl font-black text-primary">{item.branches}</span>
                      <span className="text-slate-500 text-sm">Branches</span>
                    </div>
                  </div>
                ))}
              </div>
              <div className="mt-12 bg-navy p-6 rounded-2xl flex flex-col md:flex-row items-center justify-center gap-8 text-white shadow-xl">
          ...
          <section className="py-20 px-6 md:px-20 bg-white">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-2">
                <h2 className="text-3xl md:text-4xl font-black text-navy mb-8 leading-tight">Guided by 18+ Years of <span className="text-primary">Experience</span></h2>
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={item.title} className="flex items-start gap-4 group">
                      <div className="mt-1 flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
          ...
          {/* CTA Section */}
          <section className="py-20 px-6 md:px-20">
            <div className="max-w-4xl mx-auto text-center bg-navy p-12 rounded-[2rem] shadow-2xl relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button className="w-full sm:w-auto px-10 py-4 bg-primary text-white font-bold rounded-full text-lg hover:scale-105 transition-transform shadow-lg shadow-primary/30">Get Started Today</button>
