                ...
                <div className="max-w-4xl mx-auto space-y-8 md:space-y-12">
                    ...
                    <AnimatePresence>
                        {isSuccess && (
                            <motion.div 
                                ...
                                className="bg-white rounded-[32px] md:rounded-[40px] p-8 md:p-12 text-center border-4 border-green-50 shadow-2xl shadow-green-100 relative overflow-hidden group"
                            >
                                <div className="absolute top-0 right-0 w-32 h-32 bg-green-50 rounded-bl-full opacity-50 -mr-12 -mt-12 transition-all group-hover:scale-110" />
                                ...
                                <div className="relative z-10 space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-gray-500 font-medium text-sm md:text-base px-4">
                                            Your order <span className="text-indigo-600 font-black">#{successOrderId?.slice(0, 8).toUpperCase()}</span> is being processed. 
                                            We've sent the details to your email.
                                        </p>
                                    </div>
                                    
                                    <div className="flex flex-col md:flex-row items-center justify-center gap-3 pt-2">
                                        <button onClick={() => navigate('/order')} className="w-full md:w-auto px-8 py-4 bg-gray-900 text-white rounded-2xl font-black text-sm hover:bg-black transition-all flex items-center justify-center gap-2 group shadow-xl shadow-gray-200">
                                            <ShoppingBag size={18} />
                                            Continue Shopping
                                        </button>
                    ...
                    {!isSuccess && (
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 px-4">
                            <div className="text-center md:text-left space-y-1">
                                ...
                                <p className="text-gray-500 font-medium uppercase tracking-widest text-[10px] md:text-xs">Your lifetime purchases with Apex Classes</p>
                            </div>
                            <div className="hidden md:flex p-3 bg-white rounded-2xl shadow-sm border border-gray-100 items-center gap-3 group hover:border-indigo-100 transition-all cursor-default">
                    ...
                    {!Array.isArray(orders) || orders.length === 0 ? (
                        <div className="bg-white rounded-[40px] p-12 md:p-20 text-center border border-gray-100 shadow-2xl shadow-gray-200/50">
                            <div className="w-24 h-24 bg-gray-50 text-gray-200 rounded-[30px] flex items-center justify-center mx-auto mb-8 rotate-12 group hover:rotate-0 transition-transform">
                                 <ShoppingBag size={48} />
                            </div>
                            ...
                            {orders.map(order => (
                                ...
                                >
                                    <div className="p-6 md:p-10 space-y-6 md:space-y-8">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                            <div className="flex items-center gap-4 md:gap-6">
                                                <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-50 text-indigo-600 rounded-2xl md:rounded-3xl flex items-center justify-center group-hover:bg-indigo-50 transition-colors">
                                                    <Package size={28} className="md:size-32" />
                                                </div>
                                                <div className="min-w-0">
                                                    <h3 className="text-xl md:text-2xl font-black text-gray-900 capitalize tracking-tight leading-none mb-2 outline-none">{order.product_type}</h3>
                                                    <div className="flex items-center gap-2 text-gray-400 text-[10px] md:text-xs font-bold uppercase tracking-widest leading-none">
                                                        <Clock size={12} />
                                            ...
                                            <div className="flex items-center justify-between md:justify-end gap-6 bg-gray-50/50 md:bg-transparent p-4 md:p-0 rounded-2xl">
                                                ...
                                                <span className={`px-4 py-2 md:py-2.5 rounded-xl md:rounded-2xl text-[10px] md:text-xs font-black tracking-widest uppercase flex items-center gap-2 ${order.status === 'SUCCESS' ? 'bg-green-500 text-white shadow-lg shadow-green-100' : 'bg-orange-500 text-white shadow-lg shadow-orange-100'}`}>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 pt-6 md:pt-8 border-t border-gray-100">
                                            <div className="flex items-center gap-6">
                                                <div className="space-y-1">
                                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Detail Actions</p>
                                                    <button 
                                            ...
                                            <div className="flex items-center justify-end gap-3 md:gap-4">
                                                <button 
                                                    ...
                                                    className="flex-1 md:flex-none px-5 md:px-6 py-3.5 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl md:rounded-2xl text-xs md:text-sm font-black flex items-center justify-center gap-2 transition-all"
                                                >
                        ...
                        >
                            ...
                            >
                                <button 
                                    ...
                                    className="absolute top-6 right-6 p-2 bg-gray-100 rounded-full hover:bg-gray-200 z-10 transition-colors shadow-sm"
                                >
